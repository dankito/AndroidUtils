...
import net.dankito.android.util.model.NotificationConfig;
import net.dankito.android.util.model.NotificationInfo;
...
public class NotificationsService {
  ...
  public void showNotification(NotificationConfig config, String tag) {
    ...
    Class<Activity> activityToShowOnTap = config.getActivityToShowOnTap();
    if(activityToShowOnTap != null) {
      Intent intent = new Intent(context, activityToShowOnTap);

      // Adds the back stack for the Intent (but not the Intent itself)
      stackBuilder.addParentStack(activityToShowOnTap);
